...
# 🔩 Technologies:
- Event-level analytics platform Snowplow
- Excel/Sheets
- SQL SnowFlake
- Python
- Power Bi
...
Achieved through SQL logic parameters:
<br>
<br>
<br>
...
Arithmetic validation for Comission Payout 
<br>
...
<br> SELECT * FROM validation_missing_required_fields UNION ALL SELECT * FROM validation_unknown_affiliate UNION ALL SELECT * FROM validation_conversion_before_click;
<br>
...
- (W.I.P note: how are we translating this into power bi? ID to name attributes, Flagging email system, pay out pile up)
-
-
-
-
